...
class TestZertzLogic(unittest.TestCase):
    ...
    def test_put_action(self):
        board = Board(19, t=2)
        board.take_action((('PUT', 'w', (4, 4)), ('REM', (4, 3))))
        ...
        board.take_action((('PUT', 'b', (3, 4)), ('REM', (4, 2))))
    ...
    def test_get_capture_moves(self):
        ...
        board.take_action((('PUT', 'w', (4, 4)), ('REM', (4, 3))))
        board.take_action((('PUT', 'b', (3, 4)), ('REM', (4, 2))))
        board.take_action((('PUT', 'g', (2, 3)), ('REM', (1, 3))))
        board.take_action((('PUT', 'b', (1, 1)), ('REM', (3, 1))))
        board.take_action((('PUT', 'b', (2, 1)), ('REM', (0, 2))))
        board.take_action((('PUT', 'w', (3, 3)), ('REM', (0, 0))))
    ...
    def test_separated_board_simple(self):
        ...
        board = Board(19)
        board.take_action((('PUT', 'b', (0, 0)), ('REM', (3, 1))))
        board.take_action((('PUT', 'b', (0, 2)), ('REM', (2, 0))))
        board.take_action((('PUT', 'b', (2, 4)), ('REM', (2, 1))))
        board.take_action((('PUT', 'b', (4, 2)), ('REM', (3, 2))))
        self.assertEqual(board.state[3, 4, 2], 1)
        board.take_action((('PUT', 'b', (2, 2)), ('REM', (4, 3))))
        ...
        board.take_action((('PUT', 'b', (2, 4)), ('REM', (2, 1))))
        board.take_action((('PUT', 'b', (4, 2)), ('REM', (3, 2))))
        board.take_action((('PUT', 'b', (1, 0)), ('REM', (0, 1))))
        self.assertEqual(board.state[3, 4, 2], 1)
        board.take_action((('PUT', 'b', (2, 2)), ('REM', (4, 3))))
        self.assertEqual(board.state[3, 4, 2], 0)
        self.assertEqual(board.state[0, 4, 2], 0)
    ...
    def test_separated_board_complex(self):
        ...
        board.take_action((('PUT', 'b', (0, 2)), ('REM', (2, 0))))
        board.take_action((('PUT', 'b', (2, 4)), ('REM', (2, 1))))
        board.take_action((('PUT', 'w', (4, 2)), ('REM', (3, 2))))
        board.take_action((('PUT', 'b', (2, 2)), ('REM', (4, 4))))
        board.take_action((('PUT', 'b', (1, 3)), ('REM', (3, 4))))
        self.assertEqual(board.state[1, 4, 2], 1)
        # This action creates a separable region but that region has empty rings
        board.take_action((('PUT', 'b', (0, 1)), ('REM', (3, 3))))
        ...
        board.take_action((('PUT', 'w', (4, 3)), ('REM', (1, 0))))
        self.assertEqual(board.state[0, 4, 2], 0)
...
class TestZertzGame(unittest.TestCase):
    ...
    def test_take_actions(self):
        ...
        game.get_next_state((('PUT', 'g', (2, 3)), ('REM', (1, 3))))
        game.get_next_state((('PUT', 'b', (1, 1)), ('REM', (3, 1))))
        state, player_value = game.get_next_state((('PUT', 'b', (2, 1)), ('REM', (0, 2))))
        self.assertTrue(np.all(state[5:8, 0, 0] == [5, 7, 7]))
        self.assertEqual(np.sum(state), 519)
        self.assertEqual(player_value, -1)
        state, player_value = game.get_next_state((('CAP', 'w', (4, 4)), ('b', (2, 4)), ('g', (2, 2)), ('b', (2, 0))))
